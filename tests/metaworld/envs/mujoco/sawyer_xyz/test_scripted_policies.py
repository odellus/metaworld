...
test_cases = [
    ...
    ['drawer-close-v1', SawyerDrawerCloseV1Policy(), .1, 0.77, {}],
    ...
    ['peg-insert-side-v2', SawyerPegInsertionSideV2Policy(), .0, .95, {}],
    ['peg-insert-side-v2', SawyerPegInsertionSideV2Policy(), .1, .95, {}],
